/*
 * lv_setup.hpp - Connects LVGL to the CYD ESP32-2432S024 display and touch.
...
static chipguy_cyd2432S024_display display;
...
public:
    ...
    chipguy_cyd2432S024_touch &touch() { return _touch; }

private:
    chipguy_cyd2432S024_touch _touch;
