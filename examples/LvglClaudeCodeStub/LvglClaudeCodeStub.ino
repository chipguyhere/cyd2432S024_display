/*******************************************************************************
 * CYD ESP32-2432S024 LVGL Claude Code Stub
 *
 * For the "Cheap Yellow Display" ESP32-2432S024 (ILI9341 + XPT2046 touch).
 *
 ...
 *   - chipguy_cyd2432S024_display  (display + touch driver, this library)
 *   - lvgl 9
 *
 * Arduino IDE Board Settings:
 *   - Board: "ESP32-2432S024R CYD" (in Tools > Board > esp32) — configures the
